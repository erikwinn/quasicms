<?php
	// This is the HTML template include file (.tpl.php) for product_categoryEditPanel.
...
?>
	<div id="formControls">
		...
		<?php $_CONTROL->lstParentProductCategory->RenderWithName(); ?>
		...
		<?php $_CONTROL->lstProducts->RenderWithName(true, "Rows=7"); ?>
